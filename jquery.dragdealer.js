...
var Cursor = {
	...
	setEvent: function(type) {
		var moveHandler = document['on' + type + 'move'] ||
		function() {
		};
...
Dragdealer.prototype = {
	...
	addListeners: function() {
		...
		var touchEndHandler = document.ontouchend ||
		function() {
		};
	...
	setStep: function(x, y, snap) {
		this.setValue(this.steps && x > 1 ? (x - 1) / (this.steps - 1) : 0, this.steps && y > 1 ? (y - 1) / (this.steps - 1) : 0, snap);
	},
